...
(defun main ()
  ...
  (sdl2:with-init (:everything)
    (sdl2:with-window (window :title "cl-sdl2-hershey" :w 800 :h 1320 :flags '(:shown))
      (sdl2:with-renderer (renderer window :flags '(:accelerated))
        (sdl2:with-event-loop (:method :poll)
          ...
          (:idle ()
                 ...
                 (with-font (*gothic-english-triplex-font* 1.0)
                   (render-hershey-string renderer 100 840 "Gothic English Triplex Font")
                   (render-hershey-string renderer 100 880 "ABCDEFGHIJKLMNOPQRSTUVWXYZ")
                   (render-hershey-string renderer 100 920 "abcdefghijklmnopqrstuvwxyz")
                   (render-hershey-string renderer 100 960 "0123456789"))
                 (with-font (*gothic-german-triplex-font* 1.0)
                   (render-hershey-string renderer 100 1000 "Gothic German Triplex Font")
                   (render-hershey-string renderer 100 1040 "ABCDEFGHIJKLMNOPQRSTUVWXYZ")
                   (render-hershey-string renderer 100 1080 "abcdefghijklmnopqrstuvwxyz")
                   (render-hershey-string renderer 100 1120 "0123456789"))
                 (with-font (*gothic-italian-triplex-font* 1.0)
                   (render-hershey-string renderer 100 1160 "Gothic Italian Triplex Font")
                   (render-hershey-string renderer 100 1200 "ABCDEFGHIJKLMNOPQRSTUVWXYZ")
                   (render-hershey-string renderer 100 1240 "abcdefghijklmnopqrstuvwxyz")
                   (render-hershey-string renderer 100 1280 "0123456789"))
